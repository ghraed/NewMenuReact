...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ theme, onToggle }) => {
  ...
  return (
    <button
      ...
      className="fixed right-4 top-4 z-50 inline-flex h-11 w-11 items-center justify-center rounded-full border text-[var(--guest-text)] backdrop-blur-xl transition duration-300 ease-fluid sm:right-6 sm:top-6"
      style={{
